            ...
            <div class="row">
                <div class="col-md-7">
                    ...
                    <div class="landing-text wow fadeInLeft">
                        <p>${university.shortName}</p>
                        <p>${university.longName}</p>
                ...
                <!--/.phone image-->
                <div class="col-md-5">
                    <img src="http://cfile4.uf.tistory.com/image/262C6F34580573DF079220" alt="phone"
        ...
        <div class="container">
            ...
            <div id="navbar-scroll" class="collapse navbar-collapse navbar-backyard navbar-right">
                <ul class="nav navbar-nav" style="text-align: center;">
                    <li><a href="#feature0">Schedule</a></li>
                    <li><a href="#feature1">Courses</a></li>
                    <li><a href="#feature2">Teachers</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 wow fadeInLeft">
                <div class="btn-section"><a href="${university.scheduleLink}"
                                            style="margin-left: 120px;" class="btn-default">University Schedule</a>
                </div>
            </div>
            <!-- /.feature image -->
                ...
                <div class="row row-feat" style="padding-top:0px">
                    <div class="col-md-6 text-center">
                        <div class="col-md-6 ">
                            <!-- /.feature 1 -->
                            <div class="fadeInRight" style="width:100%;">
                                <h3 class="form-title text-center">Teachers</h3>
                                <i class="pe-7s-notebook pe-5x pe-va wow fadeInUp"></i>
                                <div class="inner" style="width:100%;">
                                    <table style="margin-top:0px">
                                        <thead>
                                        ...
                                        <c:forEach items="${teachers}" var="teacher">
                                            <tr>
                                                <td><strong>${teacher.user.firstName} ${teacher.user.lastName}</strong></td>
                                                <td>${teacher.user.email}</td>
                                                <td>${teacher.user.phone}</td>
                                                <td><a href="${teacher.scheduleLink}">Schedule link</a></td>
                                                <td><a href="${teacher.filesLink}">Files link</a></td>
                                                <td>
                                                    <a href="<c:url value='/view-teacher-${teacher.id}' />"
                                                       class="clsActionButton">View</a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                    ...
                    <div class="col-sm-4 col-sm-offset-4">
                        ...
                        <div class="social text-center">
                            <ul>
                                ...
                                <li><a class="wow fadeInUp" href="https://www.facebook.com/UniHubb/"
                                       data-wow-delay="0.2s">
