...
<html>
    ...
    <body data-spy="scroll" data-target="#navbar-scroll">
        ...
        <div class="fullscreen landing parallax" style="background-image:url('../../static/images/bg.jpg');background-blend-mode: 0.2" data-img-width="2000" data-img-height="1333" data-diff="100">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <!-- /.logo -->
                            <div class="logo wow fadeInDown"> <a href=""><img src="../../static/images/logo.png" alt="mylogo" style="height: 110px; width: 350px;"></a></div>
                            ...
                            <div class="landing-text wow fadeInUp">
                                <p>UniHub is a cross-platform application aiming to simplify the way both students and teachers manage and keep track of their university tasks/schedule.</p>
                            </div>				  
                            ...
                            <div class="signup-header wow fadeInUp">
                                ...
                                <form class="form-header" action="http://moxdesign.us10.list-manage.com/subscribe/post" role="form" method="POST" id="#">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control input-lg" name="MERGE1" id="name" type="text" placeholder="Username" required>
                                    </div>
                                    <div class="form-group">
                                        <input class="form-control input-lg" name="MERGE0" id="email" type="email" placeholder="Faculty account" required>
                                    </div>
                                    <div class="form-group last">
                                        <input type="submit" class="btn btn-warning btn-block btn-lg" value="LOGIN">
                                    </div>
                                    <p class="privacy text-center">You can only log in with your <a>faculty assigned <a> account </p>
                                </form>
                            </div>				
            ...
            <nav class="navbar-wrapper navbar-default" role="navigation">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand site-name" href="#top" ><img src="../../static/images/logo.png" alt="logo" style="height: 35px; width: 95px;"></a>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 wow slideInRight">
                        ...
                        <p>An easy way to manage everything regarding university , such as attendences , grades, groups, files ,schedule and any problems .
                        </p>
                ...
                <div class="row row-feat">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="col-sm-6 feat-list">
                            ...
                            <div class="inner">
                                <h4>Instant Chat</h4>
                                <p>Bringing students and teachers together in a modern way ,free of any delays , with instant chat.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 feat-list">
                            ...
                            <div class="inner">
                            	<h4>Announcements</h4>
                                <p>A way to know all announcements and notices made by teachers for your year or study group .</p>
                        ...
                        <div class="col-sm-6 feat-list">
                            ...
                            <div class="inner">
                                <h4>Upload</h4>
                                <p>A single platform for uploading files,tasks,projects,feedback,any university files and even asking questions and giving answers and ratings .</p>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 feat-list">
                            ...
                            <div class="inner">
                                <h4>License</h4>
                                <p>Consult and choose from any licence domanins available and get a list of teachers to guide you. Ask for a 
                                1-on-1 discussion with the teacher and complete and begin and complete your paper through this site .</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 wow fadeInLeft">
                        ...
                        <p>Now you don't have to surf through the entire web to find materials , because every link , schedule, pdf materials , assignements and 
        ...
        <!-- /.download section -->
        <div id="download">
            <div class="action fullscreen parallax" style="background-image:url('../../static/images/bg.jpg');" data-img-width="2000" data-img-height="1333" data-diff="100">
                <div class="overlay">
                    <div class="container">
                        <div class="col-md-8 col-md-offset-2 col-sm-12 text-center">
                            ...
                            <p class="download-text wow fadeInLeft">If you are a representative for your college , please register as an admin with the faculty's information . We will do
                            a checkup with the faculty you want to register and afterwards you can create and manage accounts for the teachers and students. </p>
